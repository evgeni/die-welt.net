...
- Thinkpad T480s - yatsu (八), means 8, as it's a T4*8*0s
- Thinkpad X201s - nana (七), means 7, as it was my first i*7* CPU
...
- shokki (織機), means loom, which in German is Webstuhl or Webmaschine, and it's the *web*server
