...
BLOG_AUTHOR = "evgeni"  # (translatable)
BLOG_TITLE = "die-welt.net"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.die-welt.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.die-welt.net/"
BLOG_EMAIL = "evgeni@golov.de"
BLOG_DESCRIPTION = "a broken world by Evgeni Golov"  # (translatable)
...
FILES_FOLDERS = {'files': '', 'talks': 'talks'}
...
DEPLOY_COMMANDS = {
    'default': [
	    "rsync -rav --delete output/ sargentd@shokki.die-welt.net:/srv/syscp/webs/sargentd/die-welt.net",
    ]
}
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} <a href="mailto:{email}">{author}</a> / <a href="/imprint/">Imprint</a> / Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a> {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "https://comments.die-welt.net/"
